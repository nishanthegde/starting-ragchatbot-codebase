...
- `uv run black .`: format Python code with Black before committing.
...
- Format Python with Black (default style, 88-char line length) to keep style consistent across modules.
